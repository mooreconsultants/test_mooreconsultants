...
const steps = [
  ...
  },
  {
    ...
    description: "Identify and validate high-potential development opportunities in your target market.",
    icon: FileSearch,
  },
  {
    number: "03",
    title: "Feasibility & Planning",
    description: "Comprehensive financial modeling, DA preparation, and council approval coordination.",
    icon: Calculator,
  },
  {
    number: "04",
    title: "Execution",
    description: "Builder selection, contract negotiation, and hands-on construction oversight.",
    icon: HardHat,
  },
  {
    number: "05",
    title: "Profit & Scale",
    description: "Strategic sales execution and planning for your next profitable development.",
    icon: TrendingUp,
  },
]

        ...
        <div className="hidden lg:flex items-center gap-12">
          {["Services", "About", "Process", "Results"].map((item) => (
            <a
              ...
              className="text-xs tracking-widest uppercase transition-colors hover:text-moore-gold text-black"
            >
              {item}
            </a>
          ))}
          <a
            href="#contact"
            className="px-6 py-3 rounded-xl text-xs font-medium tracking-widest uppercase transition-all bg-moore-gold text-moore-white hover:bg-moore-blue shadow-md"
          >
            Free Consultation
          </a>
        </div>
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col">
      <div className="absolute inset-0 z-0">
        <Image src="/luxury-modern-architectural-building-exterior-with.jpg" alt="Modern Adelaide property development" fill priority sizes="100vw" className="object-cover" />
      ...
      <div className="relative z-10 flex flex-col justify-center flex-1 w-full max-w-[1400px] mx-auto px-6 lg:px-12 pt-28 lg:pt-36 pb-48 lg:pb-56">
        <div ref={contentRef} className="opacity-0 transition-opacity duration-1000 max-w-xl">
          <a href="/" className="text-moore-gold text-xs tracking-[0.4em] font-light mb-6 block hover:text-moore-blue transition-colors">MOORE CONSULTANTS · ADELAIDE</a>

          <h1 className="font-serif text-4xl lg:text-6xl text-moore-navy leading-[1.1] mb-6">
            Property Development
            <br />
            <span className="text-moore-charcoal">Consultant Adelaide</span>
          </h1>

          <div className="w-16 h-px bg-moore-gold mb-8 rounded-full" />

          <p className="text-moore-charcoal/80 leading-relaxed mb-10 max-w-md">
            Adelaide&apos;s only property development consultancy offering personalised, one-on-one coaching and
            end-to-end project management — backed by $23M+ in completed projects across Adelaide&apos;s coastal suburbs.
          </p>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 px-4 lg:px-8 pb-4 lg:pb-6">
        <div className="max-w-[1400px] mx-auto bg-moore-navy/95 backdrop-blur-md text-moore-offwhite px-8 lg:px-12 py-6 lg:py-8 flex flex-col sm:flex-row gap-6 lg:gap-16 rounded-t-3xl shadow-xl">
          {[
            ...
            { value: "7 Years", label: "Active in Adelaide Market" },
            { value: "100%", label: "Adelaide-Based Expertise" },
          ].map((stat, index) => (
    ...
    <section id="lead-magnet" className="py-24 lg:py-32 bg-moore-white">
      <div ref={ref} className="max-w-[1400px] mx-auto px-8 lg:px-12 opacity-0 transition-opacity duration-1000">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl lg:text-5xl text-moore-navy mb-4">Start Your Development Journey Today</h2>
          <p className="text-moore-charcoal/70 max-w-2xl mx-auto">
            Download our free tools used by successful Adelaide developers — no obligation, no sales pitch.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Adelaide Feasibility Checklist",
              description: "The exact 27-point checklist Guy uses to evaluate every Adelaide development site before committing capital.",
              cta: "Download Free Checklist",
              icon: FileSearch,
            },
            {
              title: "Free 30-Minute Consultation",
              description: "A no-obligation call with Guy Moore to discuss your goals, validate your site ideas, and map out your next steps.",
              cta: "Book Free Call",
              icon: Phone,
              href: "#contact",
            },
            {
              title: "Adelaide Market Snapshot",
              description: "Current development yields, council approval timelines, and builder availability across Adelaide's top suburbs.",
            ...
            return (
              <div key={i} className="group bg-moore-offwhite p-8 lg:p-10 rounded-2xl border border-transparent hover:border-moore-gold transition-all duration-500 relative overflow-hidden shadow-sm">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-moore-navy text-sm tracking-wide hover:text-moore-gold transition-colors group/link font-medium"
                >
                  {item.cta}
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          <div className="lg:col-span-5 lg:-mt-12">
            ...
            <h2 className="font-serif text-3xl lg:text-4xl text-moore-navy mb-10 leading-tight">
              Why Most Adelaide Developers Never Get Started
            </h2>
            <ul className="space-y-6">
              {[
                "You've done the courses but can't take the first step",
                "Analysis paralysis over Adelaide council requirements",
                "Fear of making a costly mistake in an unfamiliar market",
                "No local expert to validate your site and numbers",
                "Generic advice that doesn't account for Adelaide's unique zoning",
              ].map((item, index) => (
            ...
            <div className="relative">
              <div className="relative w-full h-[400px] lg:h-[500px]">
                <Image
                  ...
                  alt="Guy Moore consulting with Adelaide property developer"
                  fill
              ...
              <div className="bg-moore-navy p-8 lg:p-12 lg:absolute lg:-bottom-16 lg:-left-24 lg:w-[90%]">
                ...
                <h3 className="font-serif text-2xl lg:text-3xl text-moore-offwhite mb-6">
                  Adelaide&apos;s Only Hands-On Development Consultant
                </h3>
                <ul className="space-y-4">
                  {[
                    "Personalised guidance from an active Adelaide developer",
                    "Local expertise across Adelaide's coastal and metro corridors",
                    "Real feasibility models from $23M+ in completed Adelaide projects",
                    "On-site visits, council meetings, and builder introductions",
                  ].map((item, index) => (
      ...
      <div ref={ref} className="max-w-[1400px] mx-auto opacity-0 transition-opacity duration-1000">
        <div className="grid lg:grid-cols-12 min-h-[800px]">
          <div className="lg:col-span-6 relative h-[500px] lg:h-auto overflow-hidden rounded-r-2xl lg:rounded-2xl">
            <Image src="/guy-moore-portrait.jpg" alt="Guy Moore — Adelaide property development consultant" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover object-top" />
          ...
          <div className="lg:col-span-6 flex flex-col justify-center px-8 lg:px-16 py-16 lg:py-24 relative">
            ...
            <span className="text-moore-gold text-xs tracking-[0.4em] mb-6 relative z-10">YOUR ADELAIDE CONSULTANT</span>
            ...
            <p className="text-moore-charcoal/70 leading-relaxed mb-10 max-w-lg relative z-10">
              Guy Moore has spent the past seven years building and selling new homes across Adelaide&apos;s coastal suburbs,
              accumulating over $23M in completed projects. He is not a course seller or a theorist. He is an active Adelaide
              developer who works alongside a small number of clients each year, sharing the same strategies, sites, and
              financial models he uses in his own business.
            </p>

            <div className="grid grid-cols-3 gap-8 mb-10 relative z-10">
              {[
                { value: "$23M+", label: "New Homes Built & Sold" },
                { value: "7 Years", label: "Active in Adelaide" },
            ...
            <div className="flex flex-col sm:flex-row gap-4 relative z-10">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 text-moore-navy text-sm tracking-widest uppercase hover:text-moore-gold transition-colors group"
              >
              ...
              <a
                href="/"
                className="inline-flex items-center gap-2 text-moore-charcoal/60 text-sm tracking-widest uppercase hover:text-moore-gold transition-colors group"
              >
  ...
  const services = [
    {
      ...
      description: "We find and validate profitable Adelaide development sites for you",
      deliverables: ["Adelaide market analysis & site identification", "Financial feasibility modeling", "Council zoning & overlay assessment", "Negotiation support"],
      investment: "From $10,000",
    },
    {
      number: "02",
      title: "Full Project Management",
      description: "End-to-end support from DA approval through to sale",
      deliverables: ["DA/CDC coordination with Adelaide councils", "Builder selection & contracts", "Construction oversight", "Sales strategy & execution"],
      investment: "Custom Pricing",
    },
    {
      number: "03",
      title: "Tour de Coastal",
      description: "In-person tour of completed Adelaide developments",
      deliverables: ["Site visits to 3+ Adelaide projects", "Behind-the-scenes financials", "Q&A with Guy"],
      ...
      <div ref={ref} className="max-w-[1400px] mx-auto px-8 lg:px-12 opacity-0 transition-opacity duration-1000">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
          ...
          <p className="text-moore-charcoal/70 max-w-md mt-6 lg:mt-0 leading-relaxed">
            Choose the level of Adelaide-based support that matches your experience and goals.
          </p>
        </div>
...
function PdcaProcess() {
  ...
  const steps = [
    { number: "01", title: "Discovery Call", description: "Understand your goals, budget, timeline, and risk tolerance to create a tailored Adelaide development strategy.", icon: Search },
    { number: "02", title: "Site Acquisition", description: "Identify and validate high-potential development opportunities across Adelaide's best-performing suburbs.", icon: FileSearch },
    { number: "03", title: "Feasibility & Planning", description: "Comprehensive financial modeling, DA preparation, and Adelaide council approval coordination.", icon: Calculator },
    { number: "04", title: "Execution", description: "Builder selection from Guy's trusted Adelaide network, contract negotiation, and hands-on construction oversight.", icon: HardHat },
    { number: "05", title: "Profit & Scale", description: "Strategic sales execution and planning for your next profitable Adelaide development.", icon: TrendingUp },
  ]
    ...
    <section id="process" className="py-24 lg:py-32 bg-moore-offwhite overflow-hidden">
      <div ref={ref} className="max-w-[1400px] mx-auto px-8 lg:px-12 opacity-0 transition-opacity duration-1000">
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl text-moore-navy">Your Path to Profit in Adelaide</h2>
        </div>
...
function PdcaTestimonials() {
  ...
  const testimonials = [
    {
      quote: "Guy's hands-on approach transformed my theoretical knowledge into real profit. I went from paralysed by fear to completing my first development in Adelaide's coastal suburbs in 18 months.",
      name: "Ben",
      role: "First-time developer, Adelaide",
      result: "$187k profit",
    },
    {
      quote: "The personalised guidance was invaluable. Having Guy validate every major decision gave me the confidence to execute in the Adelaide market.",
      name: "Scott",
      role: "First-time developer, Adelaide",
      result: "$234k profit",
    },
  ...
  return (
    <section id="results" className="py-24 lg:py-32 bg-moore-white">
      <div ref={ref} className="max-w-[1400px] mx-auto px-8 lg:px-12 opacity-0 transition-opacity duration-1000">
        <div className="mb-16">
          <span className="text-moore-gold text-xs tracking-[0.4em] mb-4 block">ADELAIDE SUCCESS STORIES</span>
          <h2 className="font-serif text-4xl lg:text-5xl text-moore-navy">Client Results</h2>
        </div>
...
function PdcaDifferentiation() {
  ...
  const items = [
    { icon: Target, title: "Execution-Focused", description: "We build with you in Adelaide, not just teach theory" },
    { icon: Award, title: "$23M Track Record", description: "Proven results across Adelaide's coastal market" },
    { icon: Users, title: "Personalised Approach", description: "One-on-one coaching, not mass courses" },
    { icon: Handshake, title: "Aligned Incentives", description: "Your success is our success" },
    { icon: MapPin, title: "Adelaide-Based", description: "Local expertise, on-the-ground presence" },
  ]
      ...
      <div ref={ref} className="grid lg:grid-cols-2 opacity-0 transition-opacity duration-1000">
        <div className="bg-moore-navy px-8 lg:px-16 py-24 lg:py-32">
          ...
          <h2 className="font-serif text-3xl lg:text-4xl text-moore-offwhite mb-12">
            Why Adelaide Developers Choose Moore Consultants
          </h2>
        ...
        <div className="relative h-[500px] lg:h-auto">
          <Image src="/modern-luxury-property-development-aerial-view-ade.jpg" alt="Adelaide coastal property development" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-moore-navy/80 via-transparent to-transparent flex items-end p-8 lg:p-12">
            <div>
              ...
              <div className="text-moore-offwhite/80 text-sm tracking-widest uppercase mb-4">In Completed Adelaide Projects</div>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitContactSubmission({
        sourcePage: "/property-development-consultant-adelaide",
        sourceComponent: "PdcaCta",
  ...
  return (
    <section id="contact" className="relative py-24 lg:py-32 overflow-hidden">
      <div className="absolute inset-0">
        <Image src="/modern-architectural-home-interior-with-natural-li.jpg" alt="Background" fill sizes="100vw" className="object-cover" />
      ...
      <div ref={ref} className="relative max-w-[900px] mx-auto px-8 opacity-0 transition-opacity duration-1000">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl text-moore-offwhite mb-6">
            ...
            <br />
            Profitable Adelaide Development?
          </h2>
          <p className="text-moore-offwhite/70 text-lg max-w-xl mx-auto">
            Book a free 30-minute consultation with Guy Moore to discuss your Adelaide development goals.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <select value={formData.goal} onChange={(e) => setFormData({ ...formData, goal: e.target.value })} className="bg-transparent border border-moore-offwhite/30 rounded-xl px-6 py-4 text-moore-offwhite focus:border-moore-gold focus:outline-none transition-colors appearance-none cursor-pointer" required>
              ...
              <option value="first-project" className="bg-moore-navy">Complete First Development</option>
              <option value="scale" className="bg-moore-navy">Scale Existing Portfolio</option>
              <option value="learn" className="bg-moore-navy">Learn the Process</option>
          ...
          <div className="text-center pt-4">
            ...
            <p className="text-moore-offwhite/50 text-sm mt-6">No obligation. No sales pitch. Just honest advice from an active Adelaide developer.</p>
          </div>
        </form>
      </div>
    </section>
...
function PdcaFaq() {
  ...
  const faqs = [
    {
      question: "Property development consultant Adelaide",
      answer: "Moore Consultants is Adelaide's leading property development consultancy, founded by Guy Moore — an active developer with over $23M in completed residential projects across Adelaide's coastal suburbs. Unlike course sellers or theorists, Guy works alongside a small number of clients each year, providing personalised one-on-one coaching from site acquisition through to profitable sale. Every recommendation comes from real, in-market experience in Adelaide's property landscape.",
    },
    {
      question: "Best property development consultant Adelaide",
      answer: "Moore Consultants is widely regarded as the best property development consultant in Adelaide because of one critical difference: Guy Moore is an active developer, not a course seller. With $23M+ in new homes built and sold across Adelaide's coastal market over seven consecutive years, he brings proven, current market knowledge to every client engagement. Clients receive personalised feasibility analysis, hands-on project management, and direct access to the same strategies, builder networks, and financial models Guy uses in his own developments.",
    },
    {
      question: "Property development consultant Adelaide near me",
    ...
    {
      question: "Trusted property development consultant Adelaide",
...
export function PdcaLandingPage() {
  return (

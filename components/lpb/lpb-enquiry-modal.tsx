...
const modalContent: Record<BundleKey, BundleModalContent> = {
  ...
  "tour-foundations": {
    ...
    subheadline:
      "Start with a private site tour alongside Guy Moore in Adelaide's coastal suburbs, then move straight into the Foundations coaching programme. Normally $3,150 purchased separately, this bundle gives you both for $2,500. The Tour de Coastal is included at no extra cost. It is the ideal entry point for Adelaide professionals who want to see the reality before they commit.",
    bullets: [
      "Tour de Coastal: private site visits to active and completed Adelaide projects (valued at $650, included free)",
      ...
      "Save $650 versus purchasing separately",
    ],
  ...
  "tour-to-foundations": {
    ...
    bullets: [
      ...
      "Total if you proceed: $2,525 versus $3,150 purchased separately",
    ],
  ...
  "full-pathway": {
    ...
    subheadline:
      "The Full Site Find Pathway combines Foundations and Site Find into a single end-to-end site-find coaching programme for the Adelaide market. You get the preparation and the execution, with Guy alongside you from your first strategy session through to securing your first site. This pathway is about getting your structures right and finding the right site, not project managing the build. Flexible milestone-based payments mean you are never paying for a stage you have not started.",
    bullets: [
      "Foundations: entity structuring, finance readiness, and first Adelaide project strategy",
      "Site Find: Adelaide site identification, feasibility modelling, due diligence, and negotiation coaching",
      "Valued at $13,650 purchased separately",
      "Save $4,150 — 30% off versus purchasing separately",
    ],

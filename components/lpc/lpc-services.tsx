...
const services = [
  ...
  },
  {
    ...
    standardPrice: "$3,000",
    saving: "Save $850 -- both at early bird rates",
    highlight: false,
    description:
    ...
    includes: [
      "Tour de Coastal at early bird rate ($400)",
      "Foundations at early bird rate ($1,750)",
      "Seamless progression from seeing it to planning it",
      "Total saving: $850 versus standard individual prices",
    ],
    cta: "CLAIM EARLY BIRD RATE",
  },
  {
    ...
    saving: "Save $1,500 + milestone payment plan",
    highlight: false,
    description:
    ...
    includes: [
      "Foundations at early bird rate ($1,750)",
      "Live Deals at early bird rate ($6,750)",
      "Flexible payment plan: 20% upfront, then 3 x 25% at milestones",
      "Total saving: $1,500 versus standard bundle price",
    ],
    cta: "CLAIM EARLY BIRD RATE",
  },
]

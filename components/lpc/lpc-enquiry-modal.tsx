...
const modalContent: Record<EarlyBirdKey, EarlyBirdModalContent> = {
  ...
  "foundations-bundle": {
    eyebrow: "TOUR + FOUNDATIONS BUNDLE",
    headline: "See it, then build the strategy. The Tour is on us.",
    subheadline:
      "The Tour de Coastal and Foundations combined at bundle pricing. Walk Adelaide development sites with Guy, then move straight into the Foundations coaching programme. The Tour de Coastal is included at no extra cost.",
    bullets: [
      "Tour de Coastal (valued at $650) — included free",
      "Foundations one-on-one coaching programme ($2,500)",
      "Bundle total: $2,500 (versus $3,150 purchased separately)",
      "Save $650 versus purchasing individually",
    ],
    formHeading: "Enquire about the Tour + Foundations bundle",
    ctaLabel: "CLAIM THIS BUNDLE",
    earlyBirdPrice: "$2,500",
    standardPrice: "$3,150",
    saving: "Save $650 — Tour included free",
    urgency: "End-of-month pricing closes at the end of this month. Standard prices resume after.",
  },
  "full-pathway": {
    eyebrow: "FULL SITE FIND PATHWAY BUNDLE",
    headline: "Foundations and Site Find. One programme, one price. Pay in milestones.",
    subheadline:
      "The Full Site Find Pathway combines Foundations and Site Find into a single end-to-end site find coaching programme for the Adelaide market. With flexible milestone-based payments so you are never paying for a stage you have not started.",
    bullets: [
      "Foundations coaching programme ($2,500 standard)",
      "Site Find coaching programme ($10,500 standard)",
      "Bundle total: $9,500 (versus $13,650 purchased separately)",

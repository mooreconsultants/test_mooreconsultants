...
const modalContent: Record<EarlyBirdKey, EarlyBirdModalContent> = {
  ...
  "full-pathway": {
    eyebrow: "EARLY BIRD -- FULL SITE FIND PATHWAY",
    headline: "Foundations and Live Deals. Both at early bird rates. Pay in milestones.",
    subheadline:
      "The Full Site Find Pathway combines Foundations and Live Deals into a single end-to-end site find coaching programme for the Adelaide market. Both services at their early bird rates, with flexible milestone-based payments so you are never paying for a stage you have not started.",
    bullets: [
      "Foundations at early bird rate: $2,000 (save $500)",
      "Live Deals at early bird rate: $7,500",
      "Bundle total: $9,500 (versus $12,000 at standard bundle price)",
      "Flexible payment plan: $2,000 upfront, then 3 x $2,500 at agreed milestones",
    ],
    formHeading: "Claim your early bird Full Site Find Pathway",
    ctaLabel: "CLAIM EARLY BIRD PRICING",
    earlyBirdPrice: "$9,500",
    standardPrice: "$12,000",
    saving: "Save $2,500 versus standard bundle price",
    urgency: "Early bird pricing closes at the end of this month. Standard prices resume after.",
  },
}

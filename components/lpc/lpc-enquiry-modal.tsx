...
const modalContent: Record<EarlyBirdKey, EarlyBirdModalContent> = {
  ...
  foundations: {
    ...
    bullets: [
      ...
      "Early bird price: $1,750 (standard price: $2,000 -- save $250)",
    ],
    formHeading: "Claim your early bird Foundations programme",
    ctaLabel: "CLAIM EARLY BIRD PRICING",
    earlyBirdPrice: "$1,750",
    standardPrice: "$2,000",
    saving: "Save $250 -- early bird rate",
    urgency: "Early bird pricing closes at the end of this month. Standard price resumes after.",
  },
  "foundations-bundle": {
    ...
    bullets: [
      "Tour de Coastal at early bird rate: $400 (save $100)",
      "Foundations at early bird rate: $1,750 (save $250)",
      "Bundle total: $2,150 (versus $3,000 at standard individual prices)",
      "Total saving: $850 versus standard individual pricing",
    ],
    formHeading: "Claim your early bird Tour + Foundations bundle",
    ctaLabel: "CLAIM EARLY BIRD PRICING",
    earlyBirdPrice: "$2,150",
    standardPrice: "$3,000",
    saving: "Save $850 versus standard individual prices",
  ...
  "full-pathway": {
    ...
    bullets: [
      "Foundations at early bird rate: $1,750 (save $250)",
      "Live Deals at early bird rate: $6,750 (save $1,250)",
      "Bundle total: $8,500 (versus $10,000 at standard bundle price)",
      "Flexible payment plan: 20% upfront ($1,700), then 3 x 25% at agreed milestones",
    ],
    formHeading: "Claim your early bird Full Development Pathway",
    ctaLabel: "CLAIM EARLY BIRD PRICING",
    earlyBirdPrice: "$8,500",
    standardPrice: "$10,000",
    saving: "Save $1,500 versus standard bundle price",
    urgency: "Early bird pricing closes at the end of this month. Standard prices resume after.",
  },
}
